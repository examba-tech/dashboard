        ...
        <div>
          <h5 className="text-lg font-semibold text-black dark:text-white pt-3">
            {selectedMunicipi === "Tots"
               ? `Evolució del número de visites cada 10.000 habitants des del ${formattedBeginDate} al ${formattedEndDate}`
      ...
      <div className="mb-2">
        <ResponsiveContainer width="100%" height={480}>
          ...
          >
            ...
            />
            <YAxis tick={{ fontSize: 10 }} domain={[0, 40]} /> {/* Fijar la escala */}
            <Tooltip
              ...
              <Line type="monotone" dataKey="data" stroke="#2471A3" name={selectedMunicipi} />
              <Line type="monotone" dataKey="data2" stroke="#85C1E9" name={selectedSecondMunicipi} />
