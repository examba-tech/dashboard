        ...
        {isVisible ? (
          <div>
            ...
            <ul className="flex flex-col mt-6">
              <li><Link href="/log_in/about" className="block py-2 px-4 hover:bg-gray-700">Sobre Nosotros</Link></li>
              <li><Link href="/log_in/analytics" className="block py-2 px-4 hover:bg-gray-700">Taula</Link></li>
              <li><Link href="/log_in/dashbord" className="block py-2 px-4 hover:bg-gray-700">Gràfic</Link></li>
